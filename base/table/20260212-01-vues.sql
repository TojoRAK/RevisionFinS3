...
SELECT p.* , o1.id idObj1 , o1.title wanted_title , o2.id idObj2 , o2.title offered_title FROM proposition p JOIN objet o1 ON p.wanted_id = o1.id JOIN objet o2 ON p.offered_id = o2.id; 